                ...
                <div className="mb-4">
                    ...
                    <div className="relative">
                        ...
                        {customers.map((customer)=> (
                            ...
                            <UserCircleIcon className="pointer-event-none absolute left-3 top-1/2 h-[18px]
...
<fieldset>
    ...
    <div className="flex items-center">
        ...
        <label 
        htmlFor="pending" 
        className="ml-2 text-sm flex cursor-pointer item-center gap-1.5 rounded-full bg-gray-100 px-3
    ...
    <div className="flex item-center">
        ...
        <label
        htmlFor="paid"
        className="ml-2 flex cursor-pointer item-center gap-1.5 rounded-full bg-green-500 px-3 py-1.5"
        >
